...
def test_appl():
	...
	parties = {
		...
		"Charlie": {charlie_grade: 600, charlie_ects: 5},
	}
	expr = []
	expr.append(alice_grade*alice_ects + bob_grade*bob_ects + charlie_grade*charlie_ects)
	expr.append(alice_ects + bob_ects + charlie_ects)
	expected = ( (525*7 + 475*6 + 600*5) / (100 * (7 + 6 + 5)) )
